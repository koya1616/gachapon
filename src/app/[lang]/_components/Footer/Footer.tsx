        ...
        <div className="flex flex-col items-center">
          ...
          <ul className="flex flex-wrap justify-center gap-6">
            <li>
              ...
              >
                <svg aria-hidden="true" focusable="false" viewBox="0 0 18 18" className="w-5 h-5 mr-2">
                  <path
                    fill="currentColor"
            ...
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <svg aria-hidden="true" focusable="false" viewBox="0 0 100 70" className="w-5 h-5 mr-2">
                  <path
            ...
            <li>
              <a
                ...
                rel="noopener noreferrer"
              >
                <svg aria-hidden="true" focusable="false" viewBox="0 0 18 15" className="w-5 h-5 mr-2">
                  <path
                    fill="currentColor"
